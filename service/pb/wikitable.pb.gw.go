...
var (
	pattern_WikiTable_GetTables_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 2}, []string{"api", "v1", "page"}, "", runtime.AssumeColonVerbOpt(false)))
)
